WITH bronze_layer AS (
   SELECT
        ...
        trainingprogramid,
        programid
   FROM dev_iceberg."tmkn-aws-dwh-dev-iceberg-bronze".OSUSR_R9T_CERTIFICATIONPROGRAM
),
...
silver_layer AS (
   SELECT 
        ...
        trainingprogramid,
        programid
   FROM dev_iceberg."tmkn-aws-dwh-dev-iceberg-silver".CERTIFICATION_PROGRAM_BASE
)
