...
SELECT
    ...
    TRY_CAST(NULLIF(CAST(ID_SPECIAL_CONDITION AS VARCHAR), '') AS BIGINT) AS id_special_condition,
    APPLICATION_NO AS application_no,
    TRY_CAST(NULLIF(CAST(APPLICATION_ID AS VARCHAR), '') AS BIGINT) AS application_id,
    ...
    TRY_CAST(NULLIF(CAST(REJECTED_ON AS VARCHAR), '') AS TIMESTAMP) AS rejected_on,
    REJECTED_BY AS rejected_by,
    TRY_CAST(NULLIF(CAST(DECISION_DATE AS VARCHAR), '') AS TIMESTAMP) AS decision_date,
...
bronze_normalized AS (
    SELECT
        ...
        CAST("special_condition_request_no" AS VARCHAR) AS "special_condition_request_no",
        CAST("id_special_condition" AS VARCHAR) AS "id_special_condition",
        ...
        CAST("workflow_status_special_condition" AS VARCHAR) AS "workflow_status_special_condition",
        CAST("workflow_status_special_condition_detailed" AS VARCHAR) AS "workflow_status_special_condition_detailed",
        ...
        CAST("special_condition_type" AS VARCHAR) AS "special_condition_type",
        CAST("special_condition_level" AS VARCHAR) AS "special_condition_level",
        CAST("special_condition_description" AS VARCHAR) AS "special_condition_description",
        CAST("special_condition_target" AS VARCHAR) AS "special_condition_target",
        CAST("special_condition_target_value" AS VARCHAR) AS "special_condition_target_value",
        CAST("special_condition_customer_comment" AS VARCHAR) AS "special_condition_customer_comment",
        CAST("special_condition_tamkeen_comment" AS VARCHAR) AS "special_condition_tamkeen_comment",
        CAST("support_area" AS VARCHAR) AS "support_area",
        CAST("owner" AS VARCHAR) AS "owner",
        CAST("submitted_on" AS VARCHAR) AS "submitted_on",
        CAST("verified_on" AS VARCHAR) AS "verified_on",
        CAST("verified_by" AS VARCHAR) AS "verified_by",
        ...
        CAST("rejected_by" AS VARCHAR) AS "rejected_by",
