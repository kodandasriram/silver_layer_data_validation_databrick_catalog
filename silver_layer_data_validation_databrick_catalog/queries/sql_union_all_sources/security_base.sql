...
WITH
bronze_layer AS (
-- Standalone Trino SQL generated from security_base.sql.
...
Source Tables : dev_iceberg."tmkn-aws-dwh-dev-iceberg-bronze".OSUSR_5HX_TICKET
                dev_iceberg."tmkn-aws-dwh-dev-iceberg-bronze".OSUSR_5HX_SECURITYCHEQUE
                dev_iceberg."tmkn-aws-dwh-dev-iceberg-bronze".OSUSR_NTP_APPLICATION
                dev_iceberg."tmkn-aws-dwh-dev-iceberg-bronze".OSUSR_3QQ_PROGRAMVERSION
                dev_iceberg."tmkn-aws-dwh-dev-iceberg-bronze".OSUSR_NTP_APPLICATIONCUSTOMER
                dev_iceberg."tmkn-aws-dwh-dev-iceberg-bronze".OSUSR_ZMZ_CUSTOMERPROFILE
                dev_iceberg."tmkn-aws-dwh-dev-iceberg-bronze".OSUSR_ZMZ_CUSTOMER
                dev_iceberg."tmkn-aws-dwh-dev-iceberg-bronze".OSUSR_ZMZ_COMPANY
                dev_iceberg."tmkn-aws-dwh-dev-iceberg-bronze".OSUSR_5HX_COLLECTIONMETHOD
                dev_iceberg."tmkn-aws-dwh-dev-iceberg-bronze".OSUSR_5HX_SUBMITTEDLOCATION
                dev_iceberg."tmkn-aws-dwh-dev-iceberg-bronze".OSSYS_USER
                dev_iceberg."tmkn-aws-dwh-dev-iceberg-bronze".OSUSR_TLV_BANK
                dev_iceberg."tmkn-aws-dwh-dev-iceberg-bronze".OSUSR_5HX_SECURITYTYPE
                dev_iceberg."tmkn-aws-dwh-dev-iceberg-bronze".OSUSR_5HX_SECURITYSTATUS
                dev_iceberg."tmkn-aws-dwh-dev-iceberg-bronze".OSUSR_5HX_SECURITYCHEQUESTATUS
...
SELECT
    ...
    contact_end_date,
    dbt_updated_at
FROM dev_iceberg."tmkn-aws-dwh-dev-iceberg-silver".security_base
),
...
bronze_normalized AS (
    SELECT
        ...
        CAST("security_number" AS VARCHAR) AS "security_number",
        CAST("security_type" AS VARCHAR) AS "security_type",
        CAST("security_type_id" AS VARCHAR) AS "security_type_id",
        CAST("security_status_id" AS VARCHAR) AS "security_status_id",
        CAST("security_cheque_status" AS VARCHAR) AS "security_cheque_status",
        CAST("security_cheque_ref" AS VARCHAR) AS "security_cheque_ref",
        CAST("security_cheque_no_tickets" AS VARCHAR) AS "security_cheque_no_tickets",
        CAST("security_cheque_processing_step" AS VARCHAR) AS "security_cheque_processing_step",
        CAST("workflow_status_security_cheque" AS VARCHAR) AS "workflow_status_security_cheque",
        CAST("workflow_status_detailed_security_cheque" AS VARCHAR) AS "workflow_status_detailed_security_cheque",
        CAST("program_name" AS VARCHAR) AS "program_name",
        CAST("collection_method" AS VARCHAR) AS "collection_method",
        CAST("collection_method_id" AS VARCHAR) AS "collection_method_id",
        CAST("cheque_amount" AS VARCHAR) AS "cheque_amount",
        CAST("cheque_ref_number" AS VARCHAR) AS "cheque_ref_number",
        CAST("security_amount" AS VARCHAR) AS "security_amount",
        CAST("security_application_id" AS VARCHAR) AS "security_application_id",
        CAST("bank_id" AS VARCHAR) AS "bank_id",
        CAST("bank_name" AS VARCHAR) AS "bank_name",
        CAST("submitted_location_id" AS VARCHAR) AS "submitted_location_id",
        CAST("submitted_location" AS VARCHAR) AS "submitted_location",
        CAST("delivery_method_id" AS VARCHAR) AS "delivery_method_id",
        CAST("portal_user" AS VARCHAR) AS "portal_user",
        CAST("release_agent_user_id" AS VARCHAR) AS "release_agent_user_id",
        CAST("release_comments" AS VARCHAR) AS "release_comments",
        CAST("collector_cpr" AS VARCHAR) AS "collector_cpr",
        CAST("collector_name" AS VARCHAR) AS "collector_name",
        CAST("collector_relationship_to_ente" AS VARCHAR) AS "collector_relationship_to_ente",
        ...
        CAST("replaced" AS VARCHAR) AS "replaced",
        CAST("echeque_process_external_events" AS VARCHAR) AS "echeque_process_external_events",
        ...
        CAST("security_date" AS VARCHAR) AS "security_date",
        CAST("issue_date" AS VARCHAR) AS "issue_date",
        CAST("released_on" AS VARCHAR) AS "released_on",
        CAST("replaced_on" AS VARCHAR) AS "replaced_on",
        CAST("date_collected" AS VARCHAR) AS "date_collected",
        CAST("contact_end_date" AS VARCHAR) AS "contact_end_date",
