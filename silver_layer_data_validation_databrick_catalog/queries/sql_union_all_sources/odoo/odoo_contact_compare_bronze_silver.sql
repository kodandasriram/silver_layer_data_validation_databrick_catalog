-- Compare bronze-layer Odoo contacts with silver-layer odoo_contact_base.
...
silver_layer AS (
    SELECT
        ...
        source_system_name,
        dbt_updated_at
    FROM dev_iceberg."tmkn-aws-dwh-dev-iceberg-silver".odoo_contact_base
),
...
bronze_normalized AS (
    SELECT
        ...
        CAST(moic_issued_capital AS VARCHAR) AS moic_issued_capital,
        CAST(number_of_meetings AS VARCHAR) AS number_of_meetings,
        CAST(global_rm AS VARCHAR) AS global_rm,
