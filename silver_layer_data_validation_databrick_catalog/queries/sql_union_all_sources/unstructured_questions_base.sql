...
SELECT
    TRY_CAST(NULLIF(CAST(EXTRACT_DATE AS VARCHAR), '') AS DATE) AS extract_date,
    TRY_CAST(NULLIF(CAST(ID_APPLICATION AS VARCHAR), '') AS BIGINT) AS id_application,
    ID_GUID AS id_guid,
    APPLICATION_NO AS application_no,
    QUESTION AS question,
    ANSWER_TEXT AS answer_text,
    ANSWER_BOOLEAN AS answer_boolean,
    TRY_CAST(NULLIF(CAST(ANSWER_DATE AS VARCHAR), '') AS TIMESTAMP) AS answer_date,
    TRY_CAST(NULLIF(CAST(ANSWER_NUMBER AS VARCHAR), '') AS BIGINT) AS answer_number,
    FIELD_CODE AS field_code,
    TRY_CAST(NULLIF(CAST(ID_SECTION AS VARCHAR), '') AS BIGINT) AS id_section,
    TRY_CAST(NULLIF(CAST(FORMID_SECTION AS VARCHAR), '') AS BIGINT) AS formid_section,
    NAME_SECTION AS name_section,
    DESCRIPTION_SECTION AS description_section,
    ISVISIBLE_SECTION AS isvisible_section,
    TRY_CAST(NULLIF(CAST(WEIGHT_SECTION AS VARCHAR), '') AS BIGINT) AS weight_section,
    TRY_CAST(NULLIF(CAST(ID_SECFIELD AS VARCHAR), '') AS BIGINT) AS id_secfield,
    TRY_CAST(NULLIF(CAST(SECTIONID_SECFIELD AS VARCHAR), '') AS BIGINT) AS sectionid_secfield,
    TRY_CAST(NULLIF(CAST(FIELDID_SECFIELD AS VARCHAR), '') AS BIGINT) AS fieldid_secfield,
    TRY_CAST(NULLIF(CAST(ROWPOSITION AS VARCHAR), '') AS BIGINT) AS rowposition,
    TRY_CAST(NULLIF(CAST(COLUMNPOSITION AS VARCHAR), '') AS BIGINT) AS columnposition,
    TRY_CAST(NULLIF(CAST(NUMBERCOLUMNS AS VARCHAR), '') AS BIGINT) AS numbercolumns,
    ...
    TRY_CAST(NULLIF(CAST(WEIGHT_SECFIELD AS VARCHAR), '') AS BIGINT) AS weight_secfield,
    HASMANUALVERIFICATION AS hasmanualverification,
    TRY_CAST(NULLIF(CAST(ID_FORMINST AS VARCHAR), '') AS BIGINT) AS id_forminst,
    TRY_CAST(NULLIF(CAST(FORMID_FORMINST AS VARCHAR), '') AS BIGINT) AS formid_forminst,
    ISVALID_FORMINST AS isvalid_forminst,
    TRY_CAST(NULLIF(CAST(ID_FORM AS VARCHAR), '') AS BIGINT) AS id_form,
    TRY_CAST(NULLIF(CAST(DOMAINID_FORM AS VARCHAR), '') AS BIGINT) AS domainid_form,
    ...
    TRY_CAST(NULLIF(CAST(ID_FIELD AS VARCHAR), '') AS BIGINT) AS id_field,
    ISACTIVE_FIELD AS isactive_field,
    TRY_CAST(NULLIF(CAST(DOMAINID_FIELD AS VARCHAR), '') AS BIGINT) AS domainid_field,
    ...
    TRY_CAST(NULLIF(CAST(MINIMUMTEXTLENGTH AS VARCHAR), '') AS BIGINT) AS minimumtextlength,
    TRY_CAST(NULLIF(CAST(MAXIMUMTEXTLENGTH AS VARCHAR), '') AS BIGINT) AS maximumtextlength,
    TRY_CAST(NULLIF(CAST(DEFAULTDATE AS VARCHAR), '') AS TIMESTAMP) AS defaultdate,
    TRY_CAST(NULLIF(CAST(MINIMUMDATE AS VARCHAR), '') AS TIMESTAMP) AS minimumdate,
    TRY_CAST(NULLIF(CAST(MAXIMUMDATE AS VARCHAR), '') AS TIMESTAMP) AS maximumdate,
    GROUPSEPARATOR AS groupseparator,
    DECIMALSEPARATOR AS decimalseparator,
    TRY_CAST(NULLIF(CAST(DECIMALPLACES AS VARCHAR), '') AS BIGINT) AS decimalplaces,
    TRY_CAST(NULLIF(CAST(DEFAULTNUMBER AS VARCHAR), '') AS BIGINT) AS defaultnumber,
    TRY_CAST(NULLIF(CAST(MINIMUMNUMBER AS VARCHAR), '') AS BIGINT) AS minimumnumber,
    TRY_CAST(NULLIF(CAST(MAXIMUMNUMBER AS VARCHAR), '') AS BIGINT) AS maximumnumber,
...
SELECT
    ...
    source_system_name,
    dbt_updated_at
FROM dev_iceberg."tmkn-aws-dwh-dev-iceberg-silver".unstructured_questions_base
),
...
bronze_normalized AS (
    SELECT
        ...
        CAST("id_guid" AS VARCHAR) AS "id_guid",
        CAST("application_no" AS VARCHAR) AS "application_no",
        CAST("question" AS VARCHAR) AS "question",
        CAST("answer_text" AS VARCHAR) AS "answer_text",
        CAST("answer_boolean" AS VARCHAR) AS "answer_boolean",
        CAST("answer_date" AS VARCHAR) AS "answer_date",
        CAST("answer_number" AS VARCHAR) AS "answer_number",
        CAST("field_code" AS VARCHAR) AS "field_code",
        CAST("id_section" AS VARCHAR) AS "id_section",
        CAST("formid_section" AS VARCHAR) AS "formid_section",
        CAST("name_section" AS VARCHAR) AS "name_section",
        CAST("description_section" AS VARCHAR) AS "description_section",
        CAST("isvisible_section" AS VARCHAR) AS "isvisible_section",
        CAST("weight_section" AS VARCHAR) AS "weight_section",
        CAST("id_secfield" AS VARCHAR) AS "id_secfield",
        CAST("sectionid_secfield" AS VARCHAR) AS "sectionid_secfield",
        CAST("fieldid_secfield" AS VARCHAR) AS "fieldid_secfield",
        CAST("rowposition" AS VARCHAR) AS "rowposition",
        CAST("columnposition" AS VARCHAR) AS "columnposition",
        CAST("numbercolumns" AS VARCHAR) AS "numbercolumns",
        CAST("isvisible_secfield" AS VARCHAR) AS "isvisible_secfield",
        CAST("isenabled_secfield" AS VARCHAR) AS "isenabled_secfield",
        CAST("ismandatory_secfield" AS VARCHAR) AS "ismandatory_secfield",
        CAST("weight_secfield" AS VARCHAR) AS "weight_secfield",
        CAST("hasmanualverification" AS VARCHAR) AS "hasmanualverification",
        CAST("id_forminst" AS VARCHAR) AS "id_forminst",
        CAST("formid_forminst" AS VARCHAR) AS "formid_forminst",
        CAST("isvalid_forminst" AS VARCHAR) AS "isvalid_forminst",
        CAST("id_form" AS VARCHAR) AS "id_form",
        CAST("domainid_form" AS VARCHAR) AS "domainid_form",
        CAST("name_form" AS VARCHAR) AS "name_form",
        CAST("description_form" AS VARCHAR) AS "description_form",
        CAST("baseurl" AS VARCHAR) AS "baseurl",
        CAST("urlpath" AS VARCHAR) AS "urlpath",
        CAST("isactive_form" AS VARCHAR) AS "isactive_form",
        CAST("isvalid_fieldvalue" AS VARCHAR) AS "isvalid_fieldvalue",
        CAST("ismanualverified_fieldvalue" AS VARCHAR) AS "ismanualverified_fieldvalue",
        CAST("id_field" AS VARCHAR) AS "id_field",
        CAST("isactive_field" AS VARCHAR) AS "isactive_field",
        CAST("domainid_field" AS VARCHAR) AS "domainid_field",
        CAST("datatypeid" AS VARCHAR) AS "datatypeid",
        CAST("fieldinputtypeid" AS VARCHAR) AS "fieldinputtypeid",
        CAST("description_field" AS VARCHAR) AS "description_field",
        CAST("regex" AS VARCHAR) AS "regex",
        CAST("defaulttext" AS VARCHAR) AS "defaulttext",
        CAST("minimumtextlength" AS VARCHAR) AS "minimumtextlength",
        CAST("maximumtextlength" AS VARCHAR) AS "maximumtextlength",
        CAST("defaultdate" AS VARCHAR) AS "defaultdate",
        CAST("minimumdate" AS VARCHAR) AS "minimumdate",
        CAST("maximumdate" AS VARCHAR) AS "maximumdate",
        CAST("groupseparator" AS VARCHAR) AS "groupseparator",
        CAST("decimalseparator" AS VARCHAR) AS "decimalseparator",
        CAST("decimalplaces" AS VARCHAR) AS "decimalplaces",
        CAST("defaultnumber" AS VARCHAR) AS "defaultnumber",
        CAST("minimumnumber" AS VARCHAR) AS "minimumnumber",
        CAST("maximumnumber" AS VARCHAR) AS "maximumnumber",
        CAST("expression" AS VARCHAR) AS "expression",
