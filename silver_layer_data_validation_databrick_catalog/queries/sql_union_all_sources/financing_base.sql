...
FROM dev_iceberg."tmkn-aws-dwh-dev-iceberg-bronze".OSUSR_2DA_FINANCING f
 ...
 SELECT
    ...
    financingproducttypeother,
    paymentfrequency,
    TRY_CAST(NULLIF(CAST(bankapprovaldate AS VARCHAR), '') AS TIMESTAMP) as bankapprovaldate,
    facilitieswithbank,
...
bronze_normalized AS (
    SELECT
        ...
        CAST("financingamountrequested" AS VARCHAR) AS "financingamountrequested",
        CAST("tenor" AS VARCHAR) AS "tenor",
        CAST("graceperiod" AS VARCHAR) AS "graceperiod",
        CAST("facilitytype" AS VARCHAR) AS "facilitytype",
        CAST("revolvingloan" AS VARCHAR) AS "revolvingloan",
        CAST("availabilityperiod" AS VARCHAR) AS "availabilityperiod",
        CAST("disbursementtype" AS VARCHAR) AS "disbursementtype",
        CAST("financingproducttype" AS VARCHAR) AS "financingproducttype",
        CAST("financingproducttypeother" AS VARCHAR) AS "financingproducttypeother",
        CAST("paymentfrequency" AS VARCHAR) AS "paymentfrequency",
        CAST("bankapprovaldate" AS VARCHAR) AS "bankapprovaldate",
        CAST("facilitieswithbank" AS VARCHAR) AS "facilitieswithbank",
        CAST("workingcapitalfacilitieswith" AS VARCHAR) AS "workingcapitalfacilitieswith",
        CAST("internalriskrating" AS VARCHAR) AS "internalriskrating",
        CAST("securitycoverage" AS VARCHAR) AS "securitycoverage",
        CAST("cashconversioncycle" AS VARCHAR) AS "cashconversioncycle",
        CAST("debtservicecoverageratio" AS VARCHAR) AS "debtservicecoverageratio",
        CAST("machineryandequipment" AS VARCHAR) AS "machineryandequipment",
        CAST("technology" AS VARCHAR) AS "technology",
        CAST("marketingandbranding" AS VARCHAR) AS "marketingandbranding",
        CAST("workingcapital" AS VARCHAR) AS "workingcapital",
        CAST("fixturesandfittings" AS VARCHAR) AS "fixturesandfittings",
        CAST("facilitybreakupotheramount" AS VARCHAR) AS "facilitybreakupotheramount",
        CAST("facilitybreakupothervalue" AS VARCHAR) AS "facilitybreakupothervalue",
        CAST("commentworkcapital" AS VARCHAR) AS "commentworkcapital",
        CAST("commentrevolvingloan" AS VARCHAR) AS "commentrevolvingloan",
        CAST("fixedassetsamtrequested" AS VARCHAR) AS "fixedassetsamtrequested",
        CAST("fixedassestsamtremaining" AS VARCHAR) AS "fixedassestsamtremaining",
        CAST("workingcapitalamtrequested" AS VARCHAR) AS "workingcapitalamtrequested",
        CAST("workingcapitalamtremaining" AS VARCHAR) AS "workingcapitalamtremaining",
        CAST("commentworkingcapital" AS VARCHAR) AS "commentworkingcapital",
        CAST("financingamtrequested" AS VARCHAR) AS "financingamtrequested",
        CAST("financingamtremaining" AS VARCHAR) AS "financingamtremaining",
        CAST("workingcapitalcapid" AS VARCHAR) AS "workingcapitalcapid",
        CAST("workingcapitalremaningcap" AS VARCHAR) AS "workingcapitalremaningcap",
        CAST("financingamtcapid" AS VARCHAR) AS "financingamtcapid",
        CAST("financingamtremaningcap" AS VARCHAR) AS "financingamtremaningcap",
        CAST("isanyfieldupdatedforamendmen" AS VARCHAR) AS "isanyfieldupdatedforamendmen",
