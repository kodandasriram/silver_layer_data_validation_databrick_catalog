...
WITH
bronze_layer AS (
-- Standalone Trino SQL generated from application_support_base.sql.
...
WITH BASE AS (
    ...
    CAST (NULL AS VARCHAR) AS submittedtoextassessoron,
    APPSUP.isactive,
    APPSUP.providerid,
...
SELECT
    ...
    TRY_CAST(NULLIF(CAST(APPROVEDON AS VARCHAR), '') AS TIMESTAMP) AS approvedon,
    submittedon,
...
bronze_normalized AS (
    SELECT
        ...
        CAST("submittedtoextassessoron" AS VARCHAR) AS "submittedtoextassessoron",
        CAST("isactive" AS VARCHAR) AS "isactive",
        CAST("providerid" AS VARCHAR) AS "providerid",
        CAST("externalproviderid" AS VARCHAR) AS "externalproviderid",
        CAST("genderid" AS VARCHAR) AS "genderid",
        CAST("dateofbirth" AS VARCHAR) AS "dateofbirth",
        CAST("name" AS VARCHAR) AS "name",
        CAST("nameen" AS VARCHAR) AS "nameen",
        ...
        CAST("commercialname_en" AS VARCHAR) AS "commercialname_en",
