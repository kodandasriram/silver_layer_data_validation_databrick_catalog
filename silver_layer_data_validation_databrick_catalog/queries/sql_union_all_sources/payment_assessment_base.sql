...
bronze_normalized AS (
    SELECT
        ...
        CAST("paymentstatusid" AS VARCHAR) AS "paymentstatusid",
        CAST("paymentrequesttypeid" AS VARCHAR) AS "paymentrequesttypeid",
        CAST("ibanid" AS VARCHAR) AS "ibanid",
        CAST("ibanid2" AS VARCHAR) AS "ibanid2",
        CAST("applicationid" AS VARCHAR) AS "applicationid",
        CAST("supportareaid" AS VARCHAR) AS "supportareaid",
        CAST("portaluserid" AS VARCHAR) AS "portaluserid",
        CAST("payeetypeid" AS VARCHAR) AS "payeetypeid",
        CAST("processreference" AS VARCHAR) AS "processreference",
        CAST("totalcostvalue" AS VARCHAR) AS "totalcostvalue",
        CAST("customersharevalue" AS VARCHAR) AS "customersharevalue",
        ...
        CAST("isbeingprocessed" AS VARCHAR) AS "isbeingprocessed",
        CAST("reconciliationdate" AS VARCHAR) AS "reconciliationdate",
        CAST("paymentidentifier" AS VARCHAR) AS "paymentidentifier",
        CAST("cashrequirementnumber" AS VARCHAR) AS "cashrequirementnumber",
        CAST("lastsubmissiondate" AS VARCHAR) AS "lastsubmissiondate",
        CAST("sendtoinforon" AS VARCHAR) AS "sendtoinforon",
        CAST("processedon" AS VARCHAR) AS "processedon",
        CAST("eligibilitystatusid" AS VARCHAR) AS "eligibilitystatusid",
        CAST("aitoolresult" AS VARCHAR) AS "aitoolresult",
        CAST("frombank" AS VARCHAR) AS "frombank",
        CAST("issampling" AS VARCHAR) AS "issampling",
        ...
        CAST("fawateer_flag" AS VARCHAR) AS "fawateer_flag",
        CAST("created_on_payment_request_generated" AS VARCHAR) AS "created_on_payment_request_generated",
        CAST("submitted_on_payment_request_submitted" AS VARCHAR) AS "submitted_on_payment_request_submitted",
        ...
        CAST("workflow_status_employee" AS VARCHAR) AS "workflow_status_employee",
        CAST("assigned_to" AS VARCHAR) AS "assigned_to",
        CAST("vendor_cr_license" AS VARCHAR) AS "vendor_cr_license",
        CAST("vendor_name_training_provider_name" AS VARCHAR) AS "vendor_name_training_provider_name",
        CAST("program_name" AS VARCHAR) AS "program_name",
        CAST("dimension4" AS VARCHAR) AS "dimension4",
        CAST("updated_by" AS VARCHAR) AS "updated_by",
        CAST("max_execute_payment_date" AS VARCHAR) AS "max_execute_payment_date",
        CAST("number_of_execute_payment_tries" AS VARCHAR) AS "number_of_execute_payment_tries",
