...
cte_activities_agg AS (
    SELECT
        ...
        array_join(
            array_agg(DISTINCT CAST(ID AS STRING))
                FILTER (WHERE ID IS NOT NULL),
            ' | '
        )                                                                    AS activity_id_list,

        array_join(
            array_agg(DISTINCT CAST(PSMONITORINGID AS STRING))
                FILTER (WHERE PSMONITORINGID IS NOT NULL),
            ' | '
        )                                                                    AS activity_psmonitoring_id_list,

        array_join(
            array_agg(DISTINCT CAST(AMENDMENTREQUESTID AS STRING))
                FILTER (WHERE AMENDMENTREQUESTID IS NOT NULL),
            ' | '
        )                                                                    AS activity_amendment_request_id_list,

        array_join(
            array_agg(DISTINCT CAST(ISLASTVERSION AS STRING))
...
SELECT
    ...
    TRY_CAST(NULLIF(CAST(lmra.CREATEDON AS STRING), '') AS TIMESTAMP)                              AS lmra_created_on,
    TRY_CAST(NULLIF(CAST(lmra.UPDATEDON AS STRING), '') AS TIMESTAMP)                              AS lmra_updated_on,
    sio.ID                                                                   AS sio_id,
    ...
    TRY_CAST(NULLIF(CAST(moic1.CREATEDON AS STRING), '') AS TIMESTAMP)                             AS created_on,
    TRY_CAST(NULLIF(CAST(moic1.UPDATEDON AS STRING), '') AS TIMESTAMP)                             AS updated_on,
    FALSE                                                                    AS is_deleted,
...
bronze_normalized AS (
    SELECT
        ...
        CAST(`eligibility_criteria_request_ty` AS STRING) AS `eligibility_criteria_request_ty`,
        CAST(`cr_number` AS STRING) AS `cr_number`,
        CAST(`company_category_id` AS STRING) AS `company_category_id`,
        CAST(`company_type_code` AS STRING) AS `company_type_code`,
        CAST(`nationality_code` AS STRING) AS `nationality_code`,
        CAST(`ps_monitoring_id` AS STRING) AS `ps_monitoring_id`,
        CAST(`amendment_request_id` AS STRING) AS `amendment_request_id`,
        CAST(`comnercial_name_en_raw` AS STRING) AS `comnercial_name_en_raw`,
        CAST(`comnercial_name_ar_raw` AS STRING) AS `comnercial_name_ar_raw`,
        CAST(`enterprise_gender_id` AS STRING) AS `enterprise_gender_id`,
        CAST(`enterprise_age_raw` AS STRING) AS `enterprise_age_raw`,
        CAST(`company_type` AS STRING) AS `company_type`,
        CAST(`is_virtual_raw` AS STRING) AS `is_virtual_raw`,
        CAST(`registration_date_raw` AS STRING) AS `registration_date_raw`,
        CAST(`expiration_date_raw` AS STRING) AS `expiration_date_raw`,
        CAST(`nationality` AS STRING) AS `nationality`,
        CAST(`status` AS STRING) AS `status`,
        CAST(`issued_capital` AS STRING) AS `issued_capital`,
        CAST(`local_investment` AS STRING) AS `local_investment`,
        CAST(`foreign_investment` AS STRING) AS `foreign_investment`,
        CAST(`gcc_investment` AS STRING) AS `gcc_investment`,
        CAST(`address_flat_raw` AS STRING) AS `address_flat_raw`,
        CAST(`address_road_raw` AS STRING) AS `address_road_raw`,
        CAST(`address_building_raw` AS STRING) AS `address_building_raw`,
        CAST(`address_town_raw` AS STRING) AS `address_town_raw`,
        CAST(`address_block_raw` AS STRING) AS `address_block_raw`,
        ...
        CAST(`enterprise_size` AS STRING) AS `enterprise_size`,
        CAST(`enterprise_age` AS STRING) AS `enterprise_age`,
        ...
        CAST(`cr_nationality` AS STRING) AS `cr_nationality`,
        CAST(`cr_license_status` AS STRING) AS `cr_license_status`,
        CAST(`capital_issued` AS STRING) AS `capital_issued`,
        CAST(`capital_local_investment` AS STRING) AS `capital_local_investment`,
        CAST(`capital_foreign_investment` AS STRING) AS `capital_foreign_investment`,
        CAST(`capital_gcc_investment` AS STRING) AS `capital_gcc_investment`,
        ...
        CAST(`lmra_id` AS STRING) AS `lmra_id`,
        CAST(`lmra_application_id` AS STRING) AS `lmra_application_id`,
        CAST(`lmra_payment_request_id` AS STRING) AS `lmra_payment_request_id`,
        CAST(`lmra_eligibility_criteria_request_ty` AS STRING) AS `lmra_eligibility_criteria_request_ty`,
        CAST(`lmra_code` AS STRING) AS `lmra_code`,
        CAST(`total_bahraini_disable_workers` AS STRING) AS `total_bahraini_disable_workers`,
        CAST(`is_subject_to_bahrainization` AS STRING) AS `is_subject_to_bahrainization`,
        CAST(`bahrainization_target_pct` AS STRING) AS `bahrainization_target_pct`,
        CAST(`bahrainization_current_pct` AS STRING) AS `bahrainization_current_pct`,
        CAST(`bahrainization_rate_diff_pct` AS STRING) AS `bahrainization_rate_diff_pct`,
        CAST(`no_of_investors` AS STRING) AS `no_of_investors`,
        CAST(`hwto_works` AS STRING) AS `hwto_works`,
        CAST(`active_workers` AS STRING) AS `active_workers`,
        CAST(`parallel_expats` AS STRING) AS `parallel_expats`,
        CAST(`in_progress_requests` AS STRING) AS `in_progress_requests`,
        CAST(`total_no_of_non_bahraini_workers` AS STRING) AS `total_no_of_non_bahraini_workers`,
        CAST(`no_of_non_bahraini_parallel` AS STRING) AS `no_of_non_bahraini_parallel`,
        CAST(`lmra_amendment_request_id` AS STRING) AS `lmra_amendment_request_id`,
        CAST(`lmra_created_on` AS STRING) AS `lmra_created_on`,
        CAST(`lmra_updated_on` AS STRING) AS `lmra_updated_on`,
        CAST(`sio_id` AS STRING) AS `sio_id`,
        CAST(`sio_application_id` AS STRING) AS `sio_application_id`,
        CAST(`sio_payment_request_id` AS STRING) AS `sio_payment_request_id`,
        CAST(`sio_eligibility_criteria_request_ty` AS STRING) AS `sio_eligibility_criteria_request_ty`,
        CAST(`sio_code` AS STRING) AS `sio_code`,
        CAST(`total_bahraini_workers` AS STRING) AS `total_bahraini_workers`,
        CAST(`total_bahraini_salaries` AS STRING) AS `total_bahraini_salaries`,
        CAST(`total_expatriate_salaries` AS STRING) AS `total_expatriate_salaries`,
        CAST(`total_bahraini_salaries_600` AS STRING) AS `total_bahraini_salaries_600`,
        CAST(`total_expatriate_salaries_600` AS STRING) AS `total_expatriate_salaries_600`,
        CAST(`site_visit_monitoring_id` AS STRING) AS `site_visit_monitoring_id`,
        CAST(`sio_amendment_request_id` AS STRING) AS `sio_amendment_request_id`,
        CAST(`isic_4_activity_code` AS STRING) AS `isic_4_activity_code`,
        CAST(`isic_4_activities_en` AS STRING) AS `isic_4_activities_en`,
        CAST(`isic_4_activities_ar` AS STRING) AS `isic_4_activities_ar`,
        CAST(`business_activity_code` AS STRING) AS `business_activity_code`,
        CAST(`activity_id_list` AS STRING) AS `activity_id_list`,
        CAST(`activity_psmonitoring_id_list` AS STRING) AS `activity_psmonitoring_id_list`,
        CAST(`activity_amendment_request_id_list` AS STRING) AS `activity_amendment_request_id_list`,
        CAST(`activity_islastversion_list` AS STRING) AS `activity_islastversion_list`,
        CAST(`activity_created_on` AS STRING) AS `activity_created_on`,
