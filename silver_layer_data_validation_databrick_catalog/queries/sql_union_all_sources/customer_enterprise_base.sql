...
SELECT
    ...
    CAST(NULL AS STRING) AS financing_loan_status,
    ...
    CAST(NULL AS STRING) AS rejection_reasons,
    CAST(NULL AS STRING) AS rejection_messages,
    CAST(NULL AS STRING) AS rejection_reason_count,
...
SELECT
    ...
    -- Identifiers
    CAST(c.tmkn_companyid AS STRING)                    AS company_id,
...
SELECT
    ...
    CAST(NULL AS STRING)       AS hipo_classification_rm,
    CAST(NULL AS STRING)       AS hipo_classification_assessor,
    CAST(NULL AS STRING)       AS hipo_classification_approver,
    ...
    CAST(NULL AS STRING)       AS remarks_rm,
    CAST(NULL AS STRING)       AS remarks_assessor,
    CAST(NULL AS STRING)       AS remarks_approver,
    ...
    CAST(NULL AS STRING)       AS main_record_name,
    CAST(NULL AS STRING)       AS iban_id,
    CAST(NULL AS STRING)       AS company_type,
    CAST(NULL AS STRING)       AS cr_status,
    CAST(NULL AS STRING)       AS have_audited_statement,
    CAST(NULL AS STRING)       AS subject_to_bahrainization,
    CAST(NULL AS STRING)       AS is_virtual,
    ...
    CAST(NULL AS STRING)       AS address_block,
    CAST(NULL AS STRING)       AS address_building,
    CAST(NULL AS STRING)       AS address_flat,
    CAST(NULL AS STRING)       AS address_road_street,
    CAST(NULL AS STRING)       AS contact_first_name,
    CAST(NULL AS STRING)       AS contact_last_name,
    CAST(NULL AS STRING)       AS contact_cpr,
    os2.email                   AS contact_email,
    os2.mobile_no               AS contact_mobile_number,
    CAST(NULL AS STRING)       AS contact_office_number,
    CAST(NULL AS STRING)       AS contact_nationality,
    CAST(NULL AS STRING)       AS contact_gender,
    CAST(NULL AS STRING)       AS secondary_contact_first_name,
    CAST(NULL AS STRING)       AS secondary_contact_last_name,
    CAST(NULL AS STRING)       AS secondary_contact_cpr,
    CAST(NULL AS STRING)       AS secondary_contact_designation,
    CAST(NULL AS STRING)       AS secondary_contact_email,
    CAST(NULL AS STRING)       AS secondary_contact_mobile_number,
    CAST(NULL AS STRING)       AS secondary_contact_office_number,
    CAST(NULL AS STRING)       AS secondary_contact_nationality,
    CAST(NULL AS STRING)       AS secondary_contact_gender,
    CAST(NULL AS BIGINT)        AS business_activity_count,
    CAST(NULL AS STRING)       AS isic4_codes,
    CAST(NULL AS STRING)       AS business_activities,
    ...
    CAST(NULL AS STRING)       AS bahrain_government_shareholder,
    CAST(NULL AS DECIMAL(38,8)) AS bahrain_government_ownership_pct,
    CAST(NULL AS BIGINT)        AS youth_bahraini_shareholders_count,
    CAST(NULL AS STRING)       AS tmkn_cr, --NEW
    CAST(NULL AS STRING)       AS tmkn_activitysector, --NEW
...
SELECT
    ...
    CAST(NULL AS STRING)       AS applicationstatusid,
    CAST(NULL AS STRING)       AS profilinginstanceguid,
    CAST(NULL AS STRING)       AS applicationinstanceformguid,
    CAST(NULL AS STRING)       AS applicationinstancedocguid,
    CAST(NULL AS STRING)       AS customerinstanceformguid,
    CAST(NULL AS STRING)       AS findatainstanceformguid,
    CAST(NULL AS STRING)       AS customerinstancedocguid,
    CAST(NULL AS STRING)       AS bindinginstancedocguid,
    CAST(NULL AS STRING)       AS amendapprovalinstancedocguid,
    CAST(NULL AS STRING)       AS hipoinstanceformguid,
    CAST(NULL AS STRING)       AS analysisinstanceformguid,
    ...
    CAST(NULL AS STRING)       AS workflow_status_detailed,
    CAST(NULL AS STRING)       AS is_eligible,
    CAST(NULL AS TIMESTAMP)     AS withdrawn_on,
    CAST(NULL AS TIMESTAMP)     AS confirmed_on,
    CAST(NULL AS STRING)       AS contact_designation,
    os1.bank_name,
    CAST(NULL AS STRING)       AS breakup_facility_machinery_equipment_bhd,
    CAST(NULL AS STRING)       AS breakup_facility_technology_bhd,
    CAST(NULL AS STRING)       AS breakup_facility_marketing_branding_bhd,
    CAST(NULL AS STRING)       AS breakup_facility_fixtures_fittings_bhd,
    CAST(NULL AS STRING)       AS breakup_facility_other_bhd,
    CAST(NULL AS STRING)       AS disbursement_type,
    CAST(NULL AS STRING)       AS is_revolving_facility,
    CAST(NULL AS INTEGER)       AS availability_period_months,
    CAST(NULL AS STRING)       AS repayment_period,
    CAST(NULL AS STRING)       AS financing_product_type,
    os1.loan_profit_rate        AS profit_rate_pct,
    CAST(NULL AS STRING)       AS profit_rate_type,
    ...
    CAST(NULL AS STRING)       AS contact_mobile_number,
    CAST(NULL AS STRING)       AS contact_office_number,
    CAST(NULL AS STRING)       AS contact_nationality,
    CAST(NULL AS STRING)       AS contact_gender,
    CAST(NULL AS STRING)       AS secondary_contact_first_name,
...
bronze_normalized AS (
    SELECT
        ...
        CAST(`finalapprovedtkshareamt` AS STRING) AS `finalapprovedtkshareamt`,
        ...
        CAST(`tkshare_approved` AS STRING) AS `tkshare_approved`,
        CAST(`amount_requested` AS STRING) AS `amount_requested`,
        CAST(`remaining` AS STRING) AS `remaining`,
        CAST(`customer_share` AS STRING) AS `customer_share`,
        CAST(`total_cost` AS STRING) AS `total_cost`,
        CAST(`start_date` AS STRING) AS `start_date`,
        CAST(`end_date` AS STRING) AS `end_date`,
        CAST(`contract_duration_months` AS STRING) AS `contract_duration_months`,
        ...
        CAST(`total_male_shareholders` AS STRING) AS `total_male_shareholders`,
        CAST(`total_female_shareholders` AS STRING) AS `total_female_shareholders`,
        CAST(`total_bahraini_shareholders` AS STRING) AS `total_bahraini_shareholders`,
        CAST(`total_gcc_shareholders` AS STRING) AS `total_gcc_shareholders`,
        CAST(`total_non_bahraini_shareholders` AS STRING) AS `total_non_bahraini_shareholders`,
        CAST(`total_unspecified_shareholders` AS STRING) AS `total_unspecified_shareholders`,
        CAST(`financing_tenor` AS STRING) AS `financing_tenor`,
        CAST(`approved_on_bank` AS STRING) AS `approved_on_bank`,
        CAST(`workflow_status_detailed` AS STRING) AS `workflow_status_detailed`,
        CAST(`is_eligible` AS STRING) AS `is_eligible`,
        ...
        CAST(`breakup_facility_machinery_equipment_bhd` AS STRING) AS `breakup_facility_machinery_equipment_bhd`,
        CAST(`breakup_facility_technology_bhd` AS STRING) AS `breakup_facility_technology_bhd`,
        CAST(`breakup_facility_marketing_branding_bhd` AS STRING) AS `breakup_facility_marketing_branding_bhd`,
        CAST(`breakup_facility_fixtures_fittings_bhd` AS STRING) AS `breakup_facility_fixtures_fittings_bhd`,
        CAST(`breakup_facility_other_bhd` AS STRING) AS `breakup_facility_other_bhd`,
        CAST(`disbursement_type` AS STRING) AS `disbursement_type`,
        CAST(`is_revolving_facility` AS STRING) AS `is_revolving_facility`,
        CAST(`availability_period_months` AS STRING) AS `availability_period_months`,
        CAST(`repayment_period` AS STRING) AS `repayment_period`,
        CAST(`financing_product_type` AS STRING) AS `financing_product_type`,
        CAST(`profit_rate_pct` AS STRING) AS `profit_rate_pct`,
        CAST(`profit_rate_type` AS STRING) AS `profit_rate_type`,
        CAST(`total_profit_bhd` AS STRING) AS `total_profit_bhd`,
        CAST(`total_profit_amount_calculated_bhd` AS STRING) AS `total_profit_amount_calculated_bhd`,
        ...
        CAST(`hipo_classification_rm` AS STRING) AS `hipo_classification_rm`,
        CAST(`hipo_classification_assessor` AS STRING) AS `hipo_classification_assessor`,
        CAST(`hipo_classification_approver` AS STRING) AS `hipo_classification_approver`,
        ...
        CAST(`approved_pending_customer_on` AS STRING) AS `approved_pending_customer_on`,
        ...
        CAST(`recommended_grant_rm` AS STRING) AS `recommended_grant_rm`,
        CAST(`recommended_grant_assessor` AS STRING) AS `recommended_grant_assessor`,
        CAST(`assessment_support_cap_rm` AS STRING) AS `assessment_support_cap_rm`,
        CAST(`assessment_support_cap_assessor` AS STRING) AS `assessment_support_cap_assessor`,
        CAST(`assessment_support_cap_approver` AS STRING) AS `assessment_support_cap_approver`,
        ...
        CAST(`total_requested_grant` AS STRING) AS `total_requested_grant`,
        CAST(`total_requested_financing` AS STRING) AS `total_requested_financing`,
        CAST(`consumed_amount` AS STRING) AS `consumed_amount`,
        CAST(`remaining_amount` AS STRING) AS `remaining_amount`,
        CAST(`recommended_financing_rm` AS STRING) AS `recommended_financing_rm`,
        CAST(`recommended_financing_assessor` AS STRING) AS `recommended_financing_assessor`,
        CAST(`recommended_financing_approver` AS STRING) AS `recommended_financing_approver`,
        CAST(`loan_tenor` AS STRING) AS `loan_tenor`,
        CAST(`loan_profit_rate` AS STRING) AS `loan_profit_rate`,
        CAST(`loan_total_profit_amount` AS STRING) AS `loan_total_profit_amount`,
        CAST(`loan_monthly_installment` AS STRING) AS `loan_monthly_installment`,
        CAST(`loan_grace_period` AS STRING) AS `loan_grace_period`,
        CAST(`loan_start_date` AS STRING) AS `loan_start_date`,
        CAST(`loan_end_date` AS STRING) AS `loan_end_date`,
        CAST(`requested_support_no_of_employees` AS STRING) AS `requested_support_no_of_employees`,
        CAST(`remarks_rm` AS STRING) AS `remarks_rm`,
        CAST(`remarks_assessor` AS STRING) AS `remarks_assessor`,
        CAST(`remarks_approver` AS STRING) AS `remarks_approver`,
        ...
        CAST(`main_record_name` AS STRING) AS `main_record_name`,
        CAST(`iban_id` AS STRING) AS `iban_id`,
        CAST(`company_type` AS STRING) AS `company_type`,
        CAST(`cr_status` AS STRING) AS `cr_status`,
        CAST(`have_audited_statement` AS STRING) AS `have_audited_statement`,
        CAST(`subject_to_bahrainization` AS STRING) AS `subject_to_bahrainization`,
        CAST(`is_virtual` AS STRING) AS `is_virtual`,
        ...
        CAST(`annual_revenue` AS STRING) AS `annual_revenue`,
        CAST(`audit_duration_years` AS STRING) AS `audit_duration_years`,
        CAST(`issued_capital` AS STRING) AS `issued_capital`,
        CAST(`total_bahraini_salaries` AS STRING) AS `total_bahraini_salaries`,
        CAST(`total_expatriates_salaries` AS STRING) AS `total_expatriates_salaries`,
        CAST(`total_bahraini_workers_sio` AS STRING) AS `total_bahraini_workers_sio`,
        CAST(`total_disabled_bahraini_workers_sio` AS STRING) AS `total_disabled_bahraini_workers_sio`,
        CAST(`total_non_bahraini_workers_lmra` AS STRING) AS `total_non_bahraini_workers_lmra`,
        CAST(`current_bahrainization_rate_pct` AS STRING) AS `current_bahrainization_rate_pct`,
        CAST(`target_bahrainization_rate_pct` AS STRING) AS `target_bahrainization_rate_pct`,
        CAST(`bahrainization_rate_difference_pct` AS STRING) AS `bahrainization_rate_difference_pct`,
        CAST(`in_progress_requests` AS STRING) AS `in_progress_requests`,
        CAST(`hw_to_work` AS STRING) AS `hw_to_work`,
        CAST(`active_workers` AS STRING) AS `active_workers`,
        CAST(`parallel_expat` AS STRING) AS `parallel_expat`,
        ...
        CAST(`address_road_street` AS STRING) AS `address_road_street`,
        CAST(`contact_first_name` AS STRING) AS `contact_first_name`,
        CAST(`contact_last_name` AS STRING) AS `contact_last_name`,
        CAST(`contact_cpr` AS STRING) AS `contact_cpr`,
        CAST(`contact_email` AS STRING) AS `contact_email`,
        CAST(`contact_mobile_number` AS STRING) AS `contact_mobile_number`,
        CAST(`contact_office_number` AS STRING) AS `contact_office_number`,
        CAST(`contact_nationality` AS STRING) AS `contact_nationality`,
        CAST(`contact_gender` AS STRING) AS `contact_gender`,
        CAST(`secondary_contact_first_name` AS STRING) AS `secondary_contact_first_name`,
        CAST(`secondary_contact_last_name` AS STRING) AS `secondary_contact_last_name`,
        CAST(`secondary_contact_cpr` AS STRING) AS `secondary_contact_cpr`,
        CAST(`secondary_contact_designation` AS STRING) AS `secondary_contact_designation`,
        CAST(`secondary_contact_email` AS STRING) AS `secondary_contact_email`,
        CAST(`secondary_contact_mobile_number` AS STRING) AS `secondary_contact_mobile_number`,
        CAST(`secondary_contact_office_number` AS STRING) AS `secondary_contact_office_number`,
        CAST(`secondary_contact_nationality` AS STRING) AS `secondary_contact_nationality`,
        CAST(`secondary_contact_gender` AS STRING) AS `secondary_contact_gender`,
        CAST(`business_activity_count` AS STRING) AS `business_activity_count`,
        CAST(`isic4_codes` AS STRING) AS `isic4_codes`,
        CAST(`business_activities` AS STRING) AS `business_activities`,
        CAST(`bahraini_ownership_pct` AS STRING) AS `bahraini_ownership_pct`,
        CAST(`gcc_ownership_pct` AS STRING) AS `gcc_ownership_pct`,
        CAST(`non_gcc_ownership_pct` AS STRING) AS `non_gcc_ownership_pct`,
        CAST(`bahrain_government_shareholder` AS STRING) AS `bahrain_government_shareholder`,
        CAST(`bahrain_government_ownership_pct` AS STRING) AS `bahrain_government_ownership_pct`,
        CAST(`youth_bahraini_shareholders_count` AS STRING) AS `youth_bahraini_shareholders_count`,
        CAST(`tmkn_cr` AS STRING) AS `tmkn_cr`,
        CAST(`tmkn_activitysector` AS STRING) AS `tmkn_activitysector`,
        CAST(`tmkn_totalbahrainino` AS STRING) AS `tmkn_totalbahrainino`,
        CAST(`tmkn_contactmobilenumber` AS STRING) AS `tmkn_contactmobilenumber`,
        CAST(`tmkn_contactemail` AS STRING) AS `tmkn_contactemail`,
        CAST(`tmkn_addressblock` AS STRING) AS `tmkn_addressblock`,
